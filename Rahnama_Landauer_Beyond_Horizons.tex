...
super-Landauer ($\RLs > 1$, black holes and QCD
confinement), Landauer-saturating ($\RLs = 1$,
...
The high-$T$ Casimir effect reaches $\RLs = 0$
...
arises from Debye screening~\cite{Kaczmarek2007,Linde1980}, and the
$g^5$ correction from non-perturbative magnetic
effects~\cite{KZ2005a}.  The resulting scalings are:
\begin{align}
...
High-temperature Casimir ($\RLs \to 0$) and, at
